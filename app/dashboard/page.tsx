...
export default async function DashboardLaunchpad() {
  ...
  const adminFeatures = [
    ...
    {
      title: "Duyệt đề xuất",
      description: "Xem và xử lý đề xuất chỉnh sửa từ thành viên",
      icon: <Inbox className="size-6 text-indigo-600 transition-transform duration-300 group-hover:scale-110" />,
