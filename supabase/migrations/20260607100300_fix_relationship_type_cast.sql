-- Fix: relationships.type is relationship_type_enum, JSONB ->>'relation_type' is text → cast required.
-- Also consolidates all enum cast fixes for approve_contribution.
